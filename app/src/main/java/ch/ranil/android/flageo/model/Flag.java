...
public enum Flag implements Quizable {
    ...
    GAMBIA(R.drawable.gm, R.string.gambia, 11295, "The Gambia"),
    ...
    MACEDONIA(R.drawable.mk, R.string.macedonia, 25713, "Macedonia (FYROM)"),
    ...
    MICRONESIA(R.drawable.fm, R.string.micronesia, 702, "Federated States of Micronesia"),
    ...
    SAINT_KITTS_NEVIS(R.drawable.kn, R.string.saint_kitts_nevis, 261, "St Kitts and Nevis"),
    SAINT_LUCIA(R.drawable.lc, R.string.saint_lucia, 539, "St Lucia"),
    SAINT_VINCENT_THE_GRENADINES(R.drawable.vc, R.string.saint_vincent_the_grenadines, 388, "St Vincent and the Grenadines"),
    SAMOA(R.drawable.ws, R.string.samoa, 2831),
    SAN_MARINO(R.drawable.sm, R.string.san_marino, 61),
    SAO_TOME_PRINCIPE(R.drawable.st, R.string.sao_tome_principe, 964, "São Tomé and Príncipe"),
